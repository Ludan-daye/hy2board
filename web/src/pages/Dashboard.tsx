...
export default function Dashboard() {
  ...
  const incomeCur = income.length ? income[income.length - 1] : null
  ...
  return (
    <div>
      ...
      {/* Zone 3: live — real-time traffic + speed ranking */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mb-4">
          ...
          {staticIPs.length > 0 && (
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                {staticIPs.map(ip => (
                  <div key={ip.plan_id} className="bg-zinc-950 border border-zinc-800 rounded p-3 text-xs">
